...
#列出測試者所有相關資料
@router.get("/{user_id}",response_model=Subject, response_description="list all data about subject")
...
#列出測試者所有影片
@router.get("/video/{user_id}", response_model=List[Video], response_description="list all video about subject")
...
#修改影片
@router.post("/update/{video_id}",response_model = Video, response_description="do some change in video")
